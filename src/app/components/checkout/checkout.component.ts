...
export class CheckoutComponent implements OnInit {
  ...
  completePurchase() {
    ...
    this.user$.subscribe(user => {
      var reqBody = {
        unencReq: `merchant_id=${ccMerchantId}&currency=INR&order_id=${this.utility.order.orderNo}&amount=${this.utility.orderSummary.grandTotal}&redirect_url=https://www.craftmegastore.in/api/ccavResponseHandler&cancel_url=https://www.craftmegastore.in/api/ccavResponseHandler&language=EN&customer_identifier=${user._id}`
      }
